...
$voter_id = $_SESSION['voter_id'];
$voted_events_query = "SELECT event_id FROM votes WHERE voter_id = '$voter_id'"; // Assuming the votes table tracks votes with 'voter_id' and 'event_id'
...
.event-cards-container {
    display: grid;
    grid-template-columns: repeat(4, 1fr); /* Ensure 3 items per row */
...
/* Focus effect for event button */
.event-button:focus {
    outline: 2px solid #ffcc00; /* Example focus outline */
